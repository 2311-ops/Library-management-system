...
# ---------------------------
# Paths for model and objects
# ---------------------------
BASE_DIR = os.path.dirname(__file__)  # Current directory
MODELS_DIR = os.path.join(BASE_DIR, "models")  # Folder where your pickle files are

MODEL_FILE = os.path.join(MODELS_DIR, "streamlit_cardio_model.sav")
SCALER_FILE = os.path.join(MODELS_DIR, "streamlit_scaler.pkl")
ENCODER_FILE = os.path.join(MODELS_DIR, "streamlit_encoder.pkl")
FEATURES_FILE = os.path.join(MODELS_DIR, "streamlit_feature_names.pkl")
